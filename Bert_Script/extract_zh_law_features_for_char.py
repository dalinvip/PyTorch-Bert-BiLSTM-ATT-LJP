    ...
    for input_ids, input_mask, example_indices in eval_dataloader:
        ...
        for b, example_index in enumerate(example_indices):
            ...
            if line_index in line_index_exist:
                output_json["features"].extend(all_out_features)
                continue
            else:
                ...
                output_json["layer_index"] = layer_indexes
                # print(" sentence:    ", line_index_exist)
...
if __name__ == "__main__":
    ...
    input = "./Data/cail_0530_short/data_valid-s.json"
    output = "./law_char_bert/data_valid_bert_dim{}.json".format(bert_dim)
