...
class Encoder(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.bert_linear = nn.Linear(in_features=config.bert_dim, out_features=600, bias=True)
    ...
    def forward(self, batch_features, train=False):
        ...
        bert_fea = batch_features.bert_features
        bert_fea = torch.tanh(self.bert_linear(bert_fea))
